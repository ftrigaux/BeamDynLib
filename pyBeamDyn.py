...
class PyBeamDyn(ct.CDLL):
    ...
    def initBeamDyn(self,nBeam,inputFile,idxBeam,dt=None,nt=None,t=None,DynamicSolve=None,omega=None,domega=None,gravity=None,pitch_angle=None,GlbPos=None, GlbRotBladeT0=None, GlbRot=None, RootOri=None, WrVTK=0, VTK_fps=0):
        ...
        self.f_initBeamDyn(nBeam,inputFile.encode('utf-8'),idxBeam,opt(dt,ct.c_double),opt(nt,ct.c_int),opt(t,ct.c_double),opt(DynamicSolve,ct.c_int),opt(omega,ct.c_double),opt(domega,ct.c_double),opt(gravity,ct.c_double),opt(pitch_angle,ct.c_double),opt(GlbPos,ct.c_double),opt(GlbRotBladeT0,ct.c_int),opt(RootOri,ct.c_double),opt(WrVTK,ct.c_int),opt(VTK_fps,ct.c_int),ct.byref(nxLoads),ct.byref(nxDisp))
